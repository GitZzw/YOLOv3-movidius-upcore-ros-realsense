...
tf.app.flags.DEFINE_string(
    'input_img', '/home/gf/zzw/test/OpenVINO-Darknet-YOLOv3-master/10.jpg', 'Input image')
tf.app.flags.DEFINE_string(
    'output_img', 'out.jpg', 'Output image')
tf.app.flags.DEFINE_string(
    'class_names', '/home/gf/zzw/test/OpenVINO-Darknet-YOLOv3-master/voc.names', 'File with class names')
tf.app.flags.DEFINE_string(
    'weights_file', '/home/gf/zzw/test/OpenVINO-Darknet-YOLOv3-master/yolov3-tiny_final.weights', 'Binary file with detector weights')
tf.app.flags.DEFINE_string(
    'data_format', 'NHWC', 'Data format: NCHW (gpu only) / NHWC')
tf.app.flags.DEFINE_string(
    'ckpt_file', './saved_model/model.ckpt', 'Checkpoint file')
tf.app.flags.DEFINE_string(
    'frozen_model', '/home/gf/zzw/test/OpenVINO-Darknet-YOLOv3-master/frozen_darknet_yolov3_model.pb', 'Frozen tensorflow protobuf model')
